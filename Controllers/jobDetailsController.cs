    ...
    public class jobDetailsController : BaseClass
    {
        ...
        public ActionResult jobPluginList()
        {
            ...
            foreach (var item in pluginjobs)
            {
                ...
                jd.advertisementJobsUrl = "http://spotaneedle.com/jobDetails/advertisementApplyHome/?refid=" + id + "&&val=1";
        ...
        public ActionResult NewJob(jobDetail jobDetailsModel, HttpPostedFileBase files)
        {
            ...
            if (files != null)
            {
                ...
                files.SaveAs(path);
                jobDetailsModel.CompanyLogo = "http://spotaneedle.com/Logo/" + fileName;
            }
            ...
            else
            {
                ...
                if (jobDetailsModel.jobID == 0)
                {
                    ...
                    jobDetailsModel.jobURL = "http://spotaneedle.com/jobDetails/Apply?jobID=" + jobDetailsModel.jobID;
